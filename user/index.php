...
<head>
  ...
  <style>
    ...
    .stat-box p {
      ...
      /* Mengatur elemen h3 dan p sebagai blok inline */
    }

    .stat-box p {
      /* Aturan CSS yang telah ada */
      margin-top: 5px;
      /* Jarak antara teks dan angka */
    }
  </style>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <h2 data-aos="fade-down">Selamat Datang <br><span>
                <?php echo $username; ?>
              </span></h2>
          </div>
        </div>
            ...
            <div class="accordion" id="faqAccordion">
              <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                  ...
                  <div class="accordion-body">
                    MyReport adalah platform yang digunakan untuk mengelola dan memantau progress dari berbagai rapat
                    dan tugas terkait.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                  data-bs-parent="#faqAccordion">
                  <div class="accordion-body">
                    Untuk mengubah status rapat, Anda dapat masuk ke halaman 'Progress', pilih rapat yang ingin diubah
                    statusnya, dan pilih status yang sesuai dari daftar yang tersedia. Tetapi sayangnya ini hanya bisa
              ...
              <div class="accordion-item">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                  data-bs-parent="#faqAccordion">
                  <div class="accordion-body">
                    Untuk memulai menggunakan MyReport, Anda perlu membuat akun pengguna. Setelah masuk, Anda akan
                    diarahkan ke beranda MyReport.
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                  data-bs-parent="#faqAccordion">
                  <div class="accordion-body">
                    Ya, MyReport dirancang responsif dan dapat diakses dari berbagai perangkat, termasuk ponsel pintar
                    dan tablet. Anda dapat mengakses dan mengelola rapat serta tugas-tugas terkait dari mana saja dan
                    kapan saja.
                  </div>
                </div>
              </div>
