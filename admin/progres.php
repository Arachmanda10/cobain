    ...
    <main>
        ...
        <div class="top-content">
            ...
            <div class="select-wrapper">
                <button class="btn-add filter-button" data-filter="all" style="background-color: #1aa3e7;color: black;border: none;cursor: pointer;padding: 0px 20px; margin-right:20px">Semua</button>
                <button class="btn-add filter-button" data-filter="progress" style="background-color: #c5c9cb;color: black;border: none;cursor: pointer;padding: 0px 20px; margin-right:20px">Progress</button>
                <button class="btn-add filter-button" data-filter="complete" style="background-color: #c5c9cb;color: black;border: none;cursor: pointer;padding: 0px 20px;">Selesai</button>
            </div>
        </div>
